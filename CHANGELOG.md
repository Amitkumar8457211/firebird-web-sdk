...
- From this version on the SDK is bundled from the Firebird JavaScript SDK
...
- Added isUUID method to check if it is Firebird generated id
...
- Google Analytics adapter (reuse implemented Google Analytics code to send data to Firebird servers)
...
## 15.08
- First official release compatible with Firebird Server 15.08 functionalities
