/** **********
* Altruist Web SDK
* https://github.com/Altruist/altruist-sdk-web
*********** */
/**
 * Altruist object to manage the internal queue and send requests to Altruist server. More information on {@link https://resources.count.ly/docs/altruist-sdk-for-web}
 * @name Altruist
 * @global
 * @namespace Altruist
 ...
 * var Altruist = Altruist || {};
 * Altruist.q = Altruist.q || [];
 *
 * //provide your app key that you retrieved from Altruist dashboard
 * Altruist.app_key = "YOUR_APP_KEY";
 *
 * //provide your server IP or name. Use try.count.ly for EE trial server.
 * //if you use your own server, make sure you have https enabled if you use
 * //https below.
 * Altruist.url = "https://yourdomain.com";
 *
 ...
 *
 * //track sessions automatically
 * Altruist.q.push(["track_pageview"]);
 *
 * //load altruist script asynchronously
 * (function() {
 *  var cly = document.createElement("script"); cly.type = "text/javascript";
 *  cly.async = true;
 *  //enter url of script here
 *  cly.src = "https://cdn.jsdelivr.net/altruist-sdk-web/latest/altruist.min.js";
 *  cly.onload = function(){Altruist.init()};
...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
        typeof define === 'function' && define.amd ? define(['exports'], factory) :
            (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Altruist = global.Altruist || {}));
    ...
    var Altruist = globalThis.Altruist || {};

    /**
     * Array with list of available features that you can require consent for
     * @example
     * Altruist.features = ["sessions", "events", "views", "scrolls", "clicks", "forms", "crashes", "attribution", "users", "star-rating", "location", "apm", "feedback", "remote-config"];
     */
    // Feature ENUMS
    var featureEnums = {
        SESSIONS: "sessions",
     ...
     *1 - device ID was auto generated by Altruist
     *2 - device ID was temporarily given by Altruist
    ...
    /**
     * BoomerangJS and altruist
     */
    var CDN = {
        BOOMERANG_SRC: "https://cdn.jsdelivr.net/npm/altruist-sdk-web@latest/plugin/boomerang/boomerang.min.js",
        CLY_BOOMERANG_SRC: "https://cdn.jsdelivr.net/npm/altruist-sdk-web@latest/plugin/boomerang/altruist_boomerang.js",
    };
    ...
    *  @example
    *  Altruist.onload.push(function(){
    *      console.log("script loaded");
    *  });
    */
    Altruist.onload = Altruist.onload || [];
    ...
    var AltruistClass = /*#__PURE__*/_createClass(function AltruistClass(ob) {
        _classCallCheck(this, AltruistClass);
        var self = this;
        var global = !Altruist.i;
        ...
        var consents = {};
        for (var it = 0; it < Altruist.features.length; it++) {
            consents[Altruist.features[it]] = {};
        }

        this.initialize = function() {
            this.serialize = getConfig("serialize", ob, Altruist.serialize);
            this.deserialize = getConfig("deserialize", ob, Altruist.deserialize);
            this.getViewName = getConfig("getViewName", ob, Altruist.getViewName);
            this.getViewUrl = getConfig("getViewUrl", ob, Altruist.getViewUrl);
            this.getSearchQuery = getConfig("getSearchQuery", ob, Altruist.getSearchQuery);
            this.DeviceIdType = Altruist.DeviceIdType; // it is Altruist device Id type Enums for clients to use
            ...
            log(logLevelEnums.DEBUG, "initialize, 'getViewName' callback override provided:[" + (this.getViewName !== Altruist.getViewName) + "]");
            log(logLevelEnums.DEBUG, "initialize, 'getSearchQuery' callback override provided:[" + (this.getSearchQuery !== Altruist.getSearchQuery) + "]");
            ...
            log(logLevelEnums.INFO, "initialize, Altruist initialized");
            ...
            // if not check if developer provided any ID
                ...
                else if (Altruist.device_id !== undefined) {
                    deviceIdType = DeviceIdTypeInternalEnums.DEVELOPER_SUPPLIED;
                }
            }
            ...
            if (isBrowser) {
                document.documentElement.setAttribute("data-altruist-useragent", currentUserAgentString());
            }
         ...
         * 
         * Resets Altruist to its initial state (used mainly to wipe the queues in memory).
         * Calling this will result in a loss of data
         */
        this.halt = function() {
            log(logLevelEnums.WARNING, "halt, Resetting Altruist");
            Altruist.i = undefined;
            global = !Altruist.i;
            ...
            // CONSENTS
            consents = {};
            for (var a = 0; a < Altruist.features.length; a++) {
                consents[Altruist.features[a]] = {};
            }
        ...
        * Altruist.group_features({all:["sessions","events","views","scrolls","clicks","forms","crashes","attribution","users"]});
        * //After this call Altruist.add_consent("all") to allow all features
        @example <caption>Grouping features</caption>
        * Altruist.group_features({
        *    activity:["sessions","events","views"],
        *    interaction:["scrolls","clicks","forms"]
        * });
        * //After this call Altruist.add_consent("activity") to allow "sessions","events","views"
        * //or call Altruist.add_consent("interaction") to allow "scrolls","clicks","forms"
        * //or call Altruist.add_consent("crashes") to allow some separate feature
        */
        ...
        * @param {string} feature - name of the feature, possible values, "sessions","events","views","scrolls","clicks","forms","crashes","attribution","users" or custom provided through {@link Altruist.group_features}
        ...
        */
        ...
        /**
        * Gets the current device id (of the AltruistClass instance)
        ...
        * @param {string|array} feature - name of the feature, possible values, "sessions","events","views","scrolls","clicks","forms","crashes","attribution","users", etc or custom provided through {@link Altruist.group_features}
        */
        ...
        */
        ...
        var updateConsent = function updateConsent() {
            ...
            consentTimer = setTimeout(function() {
                var consentMessage = {};
                for (var i = 0; i < Altruist.features.length; i++) {
                    if (consents[Altruist.features[i]].optin === true) {
                        consentMessage[Altruist.features[i]] = true;
                    }
                    else {
                        consentMessage[Altruist.features[i]] = false;
                    }
                }
        ...
        this.enable_offline_mode = function() {
            ...
            // clear consents
            this.remove_consent_internal(Altruist.features, false);
            offlineMode = true;
            this.device_id = "[CLY]_temp_id";
        ...
        this.disable_offline_mode = function(device_id) {
            if (!offlineMode) {
                log(logLevelEnums.WARNING, "disable_offline_mode, Altruist was not in offline mode.");
                return;
            }
        ...
        * */
        ...
        /**
        * Report custom event
        * @param {Object} event - Altruist {@link Event} object
        ...
        * */
         ...
         *  @memberof Altruist._internals
         *  @param {Event} event - altruist event
         *  @param {String} eventIdOverride - altruist event ID
         */
        ...
        * */
        ...
        /**
        * End timed event
        * @param {string|object} event - event key if string or Altruist event same as passed to {@link Altruist.add_event}
        * */
        ...
        * @param {Object} user - Altruist {@link UserDetails} object
        ...
        * @param {number=} user.dob - user's birth year used to calculate current age
		* @param {number=} user.address - user's address
		* @param {number=} user.city - user's city
		* @param {number=} user.state - user's state
		* @param {number=} user.country - user's country
		* @param {number=} user.webToken - user's webToken
		* @param {number=} user.appToken - user's appToken
        ...
        * */
        this.user_details = function(user) {
            ...
            if (this.check_consent(featureEnums.USERS)) {
                ...
                user.firstName = truncateSingleValue(user.firstName, self.maxValueSize, "user_details", log);
				user.lastName = truncateSingleValue(user.lastName, self.maxValueSize, "user_details", log);
                ...
                user.mobile = truncateSingleValue(user.mobile, self.maxValueSize, "user_details", log);
                user.gender = truncateSingleValue(user.gender, self.maxValueSize, "user_details", log);
                user.dob = truncateSingleValue(user.dob, self.maxValueSize, "user_details", log);
				user.address = truncateSingleValue(user.address, self.maxValueSize, "user_details", log);
				user.city = truncateSingleValue(user.city, self.maxValueSize, "user_details", log);
				user.country = truncateSingleValue(user.country, self.maxValueSize, "user_details", log);
				user.webToken = truncateSingleValue(user.webToken, self.maxValueSize, "user_details", log);
				user.appToken = truncateSingleValue(user.appToken, self.maxValueSize, "user_details", log);
                user.custom = truncateObject(user.custom, self.maxKeyLength, self.maxValueSize, self.maxSegmentationValues, "user_details", log);
                var props = ["firstName", "lastName", "username", "email", "organization", "mobile", "gender", "dob", "address", "city", "country", "webToken", "appToken", "custom"];
        ...
        * @namespace Altruist.userData
        * @name Altruist.userData
        * @example
        * //set custom key value property
        * Altruist.userData.set("twitter", "hulk@rowboat");
        * //create or increase specific number property
        * Altruist.userData.increment("login_count");
        * //add new value to array property if it is not already there
        * Altruist.userData.push_unique("selected_category", "IT");
        ...
        * */
        this.track_errors = function(segments) {
            ...
            // Indicated that for this instance of the altruist error tracking is enabled
            Altruist.i[this.app_key].tracking_crashes = true;
        ...
        * */
        ...
        /**
        * Collect possible user data from submitted forms. Add cly_user_ignore class to ignore inputs in forms or cly_user_{key} to collect data from this input as specified key, as cly_user_username to save collected value from this input as username property. If not class is provided, Altruist SDK will try to determine type of information automatically.
        * @param {Object=} parent - DOM object which children to track, by default it is document body
                    ...
                    for (i = 0; i < form.elements.length; i++) {
                        ...
                        if (input && input.type !== "password") {
                            ...
                            if (input.className.indexOf("cly_user_ignore") === -1) {
								...
								else if (input.name && input.name.toLowerCase().indexOf("firstName") !== -1 || input.id && input.id.toLowerCase().indexOf("firstName") !== -1 || input.id && labelData[input.id] && labelData[input.id].toLowerCase().indexOf("firstName") !== -1) {
                                    if (!userdata.firstName) {
                                        userdata.firstName = value;
                                    }
                                    hasUserInfo = true;
                                }
								else if (input.name && input.name.toLowerCase().indexOf("lastName") !== -1 || input.id && input.id.toLowerCase().indexOf("lastName") !== -1 || input.id && labelData[input.id] && labelData[input.id].toLowerCase().indexOf("lastName") !== -1) {
                                    if (!userdata.lastName) {
                                        userdata.lastName = value;
                                    }
                                    hasUserInfo = true;
                                }
                                else if (input.name && (input.name.toLowerCase().indexOf("tel") !== -1 || input.name.toLowerCase().indexOf("mobile") !== -1 || input.name.toLowerCase().indexOf("number") !== -1 || input.name.toLowerCase().indexOf("phone") !== -1) || input.id && (input.id.toLowerCase().indexOf("tel") !== -1 || input.id.toLowerCase().indexOf("mobile") !== -1 || input.id.toLowerCase().indexOf("number") !== -1 || input.id.toLowerCase().indexOf("phone") !== -1) || input.id && labelData[input.id] && (labelData[input.id].toLowerCase().indexOf("tel") !== -1 || labelData[input.id].toLowerCase().indexOf("mobile") !== -1 || labelData[input.id].toLowerCase().indexOf("number") !== -1 || labelData[input.id].toLowerCase().indexOf("phone") !== -1)) {
                                    if (!userdata.mobile) {
        ...
        * @param {Object} AltruistFeedbackWidget - it is the widget object retrieved from get_available_feedback_widgets
        * @param {Object} AltruistWidgetData - it is the widget data object retrieved from getFeedbackWidgetData
        ...
        *   }
        * */
        this.reportFeedbackWidgetManually = function(AltruistFeedbackWidget, AltruistWidgetData, widgetResult) {
            if (!this.check_consent(featureEnums.FEEDBACK)) {
                return;
            }
            if (!(AltruistFeedbackWidget && AltruistWidgetData)) {
                log(logLevelEnums.ERROR, "reportFeedbackWidgetManually, Widget data and/or Widget object not provided. Aborting.");
                return;
            }
            if (!AltruistFeedbackWidget._id) {
            ...
            log(logLevelEnums.INFO, "reportFeedbackWidgetManually, Providing information about user with, provided result of the widget with  ID: [ " + AltruistFeedbackWidget._id + " ] and type: [" + AltruistFeedbackWidget.type + "]");

            // type specific checks to see if everything was provided
            var props = [];
            var type = AltruistFeedbackWidget.type;
            var eventKey;
            if (type === "nps") {
                if (widgetResult) {
            ...
            var event = {
                ...
                count: 1,
                segmentation: {
                    widget_id: AltruistFeedbackWidget._id,
        ...
        */
        this.initializeRatingWidgets = function(enableWidgets) {
            ...
            var stickers = document.getElementsByClassName("altruist-feedback-sticker");
        ...
        * */
        this.enableRatingWidgets = function(params) {
            ...
            if (offlineMode) {
                ...
                loadCSS(this.url + "/star-rating/stylesheets/altruist-feedback-web.css");
        ...
        * @param {Object} AltruistFeedbackWidget - Widget object, retrieved from 'get_available_feedback_widgets'
        * @param {Function} callback - Callback function with two parameters, 1st for returned widget data, 2nd for error
        * */
        this.getFeedbackWidgetData = function(AltruistFeedbackWidget, callback) {
            if (!AltruistFeedbackWidget.type) {
                log(logLevelEnums.ERROR, "getFeedbackWidgetData, Expected the provided widget object to have a type but got: [" + JSON.stringify(AltruistFeedbackWidget) + "], aborting.");
                return;
            }
            log(logLevelEnums.INFO, "getFeedbackWidgetData, Retrieving data for: [" + JSON.stringify(AltruistFeedbackWidget) + "], callback function is provided:[" + !!callback + "]");
            if (!this.check_consent(featureEnums.FEEDBACK)) {
                if (callback) {
                    callback(null, new Error("Consent for feedback not provided."));
                }
            ...
            if (AltruistFeedbackWidget.type === "nps") {
                url += "/o/surveys/nps/widget";
            }
            else if (AltruistFeedbackWidget.type === "survey") {
                url += "/o/surveys/survey/widget";
            }
            else if (AltruistFeedbackWidget.type === "rating") {
                url += "/o/surveys/rating/widget";
            }
            else {
                log(logLevelEnums.ERROR, "getFeedbackWidgetData, Unknown type info: [" + AltruistFeedbackWidget.type + "]");
                return;
            }
        ...
        * */
        this.present_feedback_widget = function(presentableFeedback, id, className, feedbackWidgetSegmentation) {
            ...
            try {
                ...
                // (at least until we add new type in future)
                    ...
                    loadCSS(this.url + "/surveys/stylesheets/altruist-surveys.css");
                ...
                iframe.src = url;
                iframe.name = "altruist-" + feedbackWidgetFamily + "-iframe";
                iframe.id = "altruist-" + feedbackWidgetFamily + "-iframe";
                var initiated = false;
                iframe.onload = function() {
                    ...
                    if (initiated) {
                        ...
                        document.getElementById("altruist-" + feedbackWidgetFamily + "-wrapper-" + presentableFeedback._id).style.display = "none";
                ...
                var wrapper = document.getElementsByClassName("altruist-" + feedbackWidgetFamily + "-wrapper");
                ...
                wrapper.className = "altruist-" + feedbackWidgetFamily + "-wrapper";
                wrapper.id = "altruist-" + feedbackWidgetFamily + "-wrapper-" + presentableFeedback._id;
                ...
                if (presentableFeedback.type === "rating") {
                    ...
                    ratingsOverlay.className = "altruist-ratings-overlay";
                    ratingsOverlay.id = "altruist-ratings-overlay-" + presentableFeedback._id;
                    ...
                    add_event_listener(document.getElementById("altruist-ratings-overlay-" + presentableFeedback._id), "click", function() {
                        document.getElementById("altruist-ratings-wrapper-" + presentableFeedback._id).style.display = "none";
                    });
                }
                ...
                if (presentableFeedback.type === "survey") {
                    ...
                    document.getElementById("altruist-" + feedbackWidgetFamily + "-wrapper-" + presentableFeedback._id).style.display = "block";
            ...
            function showSurvey(feedback) {
                document.getElementById("altruist-surveys-wrapper-" + feedback._id).style.display = "block";
                document.getElementById("csbg").style.display = "block";
            }
            ...
            function showRatingForFeedbackWidget(feedback) {
                ...
                if (!feedback.appearance.hideS) {
                    ...
                    sticker.className = "altruist-feedback-sticker  " + feedback.appearance.position + "-" + feedback.appearance.size;
                    sticker.id = "altruist-feedback-sticker-" + feedback._id;
                    document.body.appendChild(sticker);

                    // sticker event handler
                    add_event_listener(document.getElementById("altruist-feedback-sticker-" + feedback._id), "click", function() {
                        document.getElementById("altruist-ratings-wrapper-" + feedback._id).style.display = "flex";
                        document.getElementById("csbg").style.display = "block";
                    });
                }
                ...
                add_event_listener(document.getElementById("altruist-feedback-close-icon-" + feedback._id), "click", function() {
                    document.getElementById("altruist-ratings-wrapper-" + feedback._id).style.display = "none";
                    document.getElementById("csbg").style.display = "none";
                });
            }
        };
        ...
        function processWidget(currentWidget, hasSticker) {
            ...
            var isDuplicate = !!document.getElementById("altruist-feedback-sticker-" + currentWidget._id);
            if (isDuplicate) {
            ...
            try {
                ...
                wrapper.className = "altruist-iframe-wrapper";
                wrapper.id = "altruist-iframe-wrapper-" + currentWidget._id;
                // create close icon for iframe popup
                var closeIcon = document.createElement("span");
                closeIcon.className = "altruist-feedback-close-icon";
                closeIcon.id = "altruist-feedback-close-icon-" + currentWidget._id;
                closeIcon.innerText = "x";

                // create iframe
                var iframe = document.createElement("iframe");
                iframe.name = "altruist-feedback-iframe";
                iframe.id = "altruist-feedback-iframe";
                ...
                wrapper.appendChild(iframe);
                add_event_listener(document.getElementById("altruist-feedback-close-icon-" + currentWidget._id), "click", function() {
                    document.getElementById("altruist-iframe-wrapper-" + currentWidget._id).style.display = "none";
                ...
                if (hasSticker) {
                    ...
                    sticker.className = "altruist-feedback-sticker  " + currentWidget.trigger_position + "-" + currentWidget.trigger_size;
                    sticker.id = "altruist-feedback-sticker-" + currentWidget._id;
                    ...
                    add_event_listener(document.getElementById("altruist-feedback-sticker-" + currentWidget._id), "click", function() {
                        document.getElementById("altruist-iframe-wrapper-" + currentWidget._id).style.display = "block";
        ...
        function heartBeat() {
            ...
            var i = 0;
            // process queue
            if (global && typeof Altruist.q !== "undefined" && Altruist.q.length > 0) {
                var req;
                var q = Altruist.q;
                Altruist.q = [];
                for (i = 0; i < q.length; i++) {
                    ...
                    if (typeof req === "function") {
                        ...
                        if (Altruist.i[req[arg]]) {
                            inst = Altruist.i[req[arg]];
                            arg++;
                        }
                        ...
                        else if (typeof Altruist[req[arg]] === "function") {
                            Altruist[req[arg]].apply(Altruist, req.slice(arg + 1));
                        }
                    }
                }
            }
        ...
        function log(level, message) {
            if (self.debug && typeof console !== "undefined") {
                ...
                var log = level + "[Altruist] " + message + extraArguments;
        ...
        * @namespace Altruist._internals
        * @name Altruist._internals
        */
        this._internals = {
        ...
        /**
         * Altruist health check request sender
         */
        ...
        // initialize Altruist Class
        this.initialize();
    });

    Altruist.AltruistClass = AltruistClass;

    /**
     * Initialize Altruist object
     * @param {Object} conf - Altruist initialization/config {@link Init} object with configuration options
     * @param {string} conf.app_key - app key for your app created in Altruist
     * @param {string} conf.device_id - to identify a visitor, will be auto generated if not provided
     * @param {string} conf.url - your Altruist server url, you can use your server URL or IP here
     ...
     * @returns {Object} altruist tracker instance
     * @example
     * Altruist.init({
     *   //provide your app key that you retrieved from Altruist dashboard
     ...
     * });
     */
    Altruist.init = function(conf) {
        conf = conf || {};
        if (Altruist.loadAPMScriptsAsync && apmLibrariesNotLoaded) {
            apmLibrariesNotLoaded = false;
            initAfterLoadingAPM(conf);
            return;
        }
        var appKey = conf.app_key || Altruist.app_key;
        if (!Altruist.i || !Altruist.i[appKey]) {
            var inst = new AltruistClass(conf);
            if (!Altruist.i) {
                Altruist.i = {};
                for (var key in inst) {
                    Altruist[key] = inst[key];
                }
            }
            Altruist.i[appKey] = inst;
        }
        return Altruist.i[appKey];
    };

    /**
     * Altruist object methods:
     * Altruist. 
     *     AltruistClass: ƒ (ob)
     ...
     *     force_post: false
     *     getFeedbackWidgetData: ƒ (AltruistFeedbackWidget, callback)
     *     getSearchQuery: ƒ ()
     *     getViewName: ƒ ()
     *     getViewUrl: ƒ ()
     ...
     *     customSourceAltruistBoomerang: CDN.CLY_BOOMERANG_SRC or basically the cdn link to altruist_boomerang.js
     ...
     *     reportFeedbackWidgetManually: ƒ (AltruistFeedbackWidget, AltruistWidgetData, widgetResult)
     ...
     * @param {Object} conf - Altruist config object.
     */
    function initAfterLoadingAPM(conf) {
        ...
        var altruistBoomerangScript = document.createElement("script");

        // Set boomerang script attributes
        boomerangScript.async = true;
        altruistBoomerangScript.async = true;

        // Set boomerang script source
        boomerangScript.src = Altruist.customSourceBoomerang || CDN.BOOMERANG_SRC;
        altruistBoomerangScript.src = Altruist.customSourceAltruistBoomerang || CDN.CLY_BOOMERANG_SRC;

        // Append boomerang script to the head
        document.getElementsByTagName("head")[0].appendChild(boomerangScript);
        document.getElementsByTagName("head")[0].appendChild(altruistBoomerangScript);
        var boomLoaded = false;
        var altruistBoomLoaded = false;
        boomerangScript.onload = function() {
            boomLoaded = true;
        };
        altruistBoomerangScript.onload = function() {
            altruistBoomLoaded = true;
        };
        var timeoutCounter = 0;
        var intervalDuration = 50;
        var timeoutLimit = 1500; // TODO: Configurable? Mb with Altruist.apmScriptLoadTimeout?
        // init Altruist only after boomerang is loaded
        var intervalID = setInterval(function() {
            timeoutCounter += intervalDuration;
            if (boomLoaded && altruistBoomLoaded || timeoutCounter >= timeoutLimit) {
                if (Altruist.debug) {
                    var message = "BoomerangJS loaded:[" + boomLoaded + "], altruist_boomerang loaded:[" + altruistBoomLoaded + "].";
                    if (boomLoaded && altruistBoomLoaded) {
    ...
    */
    ...
    function getConfig(key, ob, override) {
        ...
        else if (typeof Altruist[key] !== "undefined") {
            return Altruist[key];
        }
        return override;
    }
    ...
    function dispatchErrors(error, fatality, segments) {
        // Check each instance like Altruist.i[app_key_1], Altruist.i[app_key_2] ...
        for (var app_key in Altruist.i) {
            // If track_errors is enabled for that instance
            if (Altruist.i[app_key].tracking_crashes) {
                // Trigger recordError function for that instance
                Altruist.i[app_key].recordError(error, fatality, segments);
            }
        }
    }
    ...
    function add_event_listener(element, type, listener) {
        ...
        if (element === null || typeof element === "undefined") {
            ...
            if (checkIfLoggingIsOn()) {
                // eslint-disable-next-line no-console
                console.warn("[WARNING] [Altruist] add_event_listener, Can't bind [" + type + "] event to nonexisting element");
            }
            return;
        }
    ...
    if (isBrowser) {
        window.addEventListener("storage", function (e) {
            ...
            if (Altruist.i && Altruist.i[appKey]) {
                Altruist.i[appKey].onStorageChange(key, e.newValue);
            }
        });
    }
    ...
    function showLoader() {
        ...
        if (!loader) {
            ...
            document.body.onload = function() {
                ...
                if (Altruist.showLoaderProtection) {
                    if (checkIfLoggingIsOn()) {
                        // eslint-disable-next-line no-console
                        console.warn("[WARNING] [Altruist] showloader, Loader is already on");
                    }
                    return;
                }
                try {
                    ...
                    if (checkIfLoggingIsOn()) {
                        // eslint-disable-next-line no-console
                        console.error("[ERROR] [Altruist] showLoader, Body is not loaded for loader to append: " + e);
                    }
                }
            };
        }
    ...
    /**
     *  Checks if debug is true and console is available in Altruist object
     *  @memberof Altruist._internals 
     * @returns {Boolean} true if debug is true and console is available in Altruist object
     */
    function checkIfLoggingIsOn() {
        // check if logging is enabled
        if (Altruist && Altruist.debug && typeof console !== "undefined") {
            return true;
        }
        return false;
    }
    ...
    function hideLoader() {
        ...
        Altruist.showLoaderProtection = true;
        var loader = document.getElementById("cly-loader");
        if (loader) {
    ...
    * */
    Altruist.serialize = function(value) {
    ...
    * */
    Altruist.deserialize = function(data) {
        if (data === "") {
        ...
        try {
            ...
            if (checkIfLoggingIsOn()) {
                // eslint-disable-next-line no-console
                console.warn("[WARNING] [Altruist] deserialize, Could not parse the file:[" + data + "], error: " + e);
            }
        }
        return data;
    };
    ...
    * @return {string} view url
    * */
    Altruist.getSearchQuery = function() {
        if (!isBrowser) {
            return;
        }
